...
var Authority = /** @class */ (function (_super) {
    ...
    ], Authority.prototype, "authorityId");
    __decorate([
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return groupauthority_1.GroupAuthority; }, function (groupAuthority) { return groupAuthority.authority; }, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
    ], Authority.prototype, "tGroupAuthoritys");
    __decorate([
    ...
    ], Authority.prototype, "resourceAuthorities");
    Authority = __decorate([
        typeorm_1.Entity("t_authority", { schema: "codement" })
    ], Authority);
    return Authority;
